...
ECHO `handyhandphone`	`sessions`	`handyhandphone1234`	`sessions`	`session_id`	`session_id`	`session_id`, `expires`, `data` >> %TMP%\wb_tables_to_migrate.txt
ECHO `handyhandphone`	`users`	`handyhandphone1234`	`users`	`id`	`id`	`id`, `name`, `email`, `verified`, `password`, `createdAt`, `updatedAt` >> %TMP%\wb_tables_to_migrate.txt
ECHO `handyhandphone`	`videos`	`handyhandphone1234`	`videos`	`id`	`id`	`id`, `title`, `story`, `starring`, `posterURL`, `language`, `subtitles`, `classification`, `dateRelease`, `createdAt`, `updatedAt`, `userId` >> %TMP%\wb_tables_to_migrate.txt
